                                ...
                                Row(children: [
                                  ...
                                  Expanded(
                                      child: DropdownButton2<String>(
                                          ...
                                          buttonStyleData: ButtonStyleData(
                                              decoration:
                                                  BoxDecoration(color: AppTheme.greyColor, borderRadius: BorderRadius.circular(10))),
                                          dropdownStyleData: DropdownStyleData(maxHeight: MediaQuery.sizeOf(context).height / 2, decoration: BoxDecoration(borderRadius: BorderRadius.circular(10))),
                                          menuItemStyleData: const MenuItemStyleData(padding: EdgeInsets.symmetric(horizontal: 16))))
                                ]),
                                                                      ...
                                                                      children: [
                                                                        ListTile(
                                                                          contentPadding: const EdgeInsets
                                                                              ...
                                                                              horizontal: 5),
                                                                          leading:
                                                                              const CircleAvatar(backgroundImage: AssetImage("assets/images/default.jpg")),
                                                                          title: Text(memberList[_index]
                                                                              .memberInfo!
                                                                              .name
                                                                              .toString()),
                                                                          subtitle:
                                                                              Text("+#$_userId ${memberList[_index].memberInfo!.userId.toString()}"),
                                                                          trailing: _userId == memberList[_index].memberInfo!.userId.toString()
                                                                              ? const SizedBox()
                                                                              : Row(
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Row(
                                                                                children: [
                                                                                  const Text("Floor No : ", style: TextStyle(color: Colors.grey)),
                                                                                  Text(memberList[_index].memberInfo!.floorNumber.toString()),
                                                                                ],
                                                                              ),
                                                                              Row(
                                                                                children: [
                                                                                  const Text("Property No : ", style: TextStyle(color: Colors.grey)),
