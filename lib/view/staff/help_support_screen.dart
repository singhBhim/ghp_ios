...
import 'package:ghp_app/controller/contact/contact_cubit.dart';
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: ListTile(
                                        ...
                                        dense: true,
                                        leading:
                                            Image.asset(getInTouchImages[0]),
                                        title: Text(
                                          getInTouchTitle[0],
                                          style:GoogleFonts.nunitoSans(
                                            color: Colors.black,
                                        ...
                                        subtitle: Text(
                                          state
                                              .contact.first.data.contact.phone,
                                          style:GoogleFonts.nunitoSans(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: ListTile(
                                        ...
                                        dense: true,
                                        leading:
                                            Image.asset(getInTouchImages[1]),
                                        title: Text(
                                          getInTouchTitle[1],
                                          style:GoogleFonts.nunitoSans(
                                            color: Colors.black,
                                        ...
                                        subtitle: Text(
                                          state
                                              .contact.first.data.contact.email,
                                          style:GoogleFonts.nunitoSans(
                                            color: const Color(0XFF404040),
                                            fontSize: 13,
                                            fontWeight: FontWeight.w500,
