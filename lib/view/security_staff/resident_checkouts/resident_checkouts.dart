...
import 'package:ghp_app/model/resident_checkouts_history_model.dart';
...
class _ResidentsCheckoutsHistoryState extends State<ResidentsCheckoutsHistory> {
                  ...
                  child: RefreshIndicator(
                    ...
                    child: BlocBuilder<StaffSideResidentCheckoutsHistoryCubit,
                      ...
                      builder: (context, state) {
                        ...
                        if (state
                            is StaffSideResidentCheckoutsHistorySearchLoaded) {
                          newHistoryLogs = state.residentCheckoutsHistoryList;
                        }
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: ((context, index) {
                            if (index == newHistoryLogs.length) {
                              return _staffSideResidentCheckoutsHistoryCubit
                                          .state
  ...
  Widget btnTypes(ResidentCheckoutsHistoryList? lastCheckinDetail) {
